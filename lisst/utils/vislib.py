...
def get_body_model(type, gender, batch_size,device='cpu', use_mano_pca=True):
    '''
    type: smpl, smplx smplh and others. Refer to smplx tutorial
    gender: male, female, neutral
    batch_size: an positive integar
    '''
    body_model_path = '/home/yzhang/body/VPoser'
    body_model = smplx.create(body_model_path, model_type=type,
                                    gender=gender, ext='npz',
                                    use_pca = use_mano_pca,
                                    num_pca_comps=12,
